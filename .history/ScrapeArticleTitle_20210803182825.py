...
def get_article_titles_from_json():
    ...
    df.to_csv('article_titles_new_0308.csv', index=False)
...
def check_if_article_itle_exist_in_tweets_csv():
    tweets_file_path = "D:\Desktop\IR_term_8\IR-tweets---disaster-\tweets_data_stemmed.csv"
    tweets_file_path = "D:\Desktop\IR_term_8\IR-tweets---disaster-\article_titles_new_0308.csv"
    tweets_data = pd.read_csv(tweets_file_path) 
    titles_data = pd.read_csv(tweets_file_path) 
...
check_if_article_itle_exist_in_tweets_csv()
