...
class DocumentTerm:
	...
	def euclidean(self, return_size):
	...
	def query(self, query_id, query_text, method, return_size=10):
		...
		if method == 'cos_sim':
			self.cos_sim(return_size)
		elif method == 'euclidean':
			self.euclidean(return_size)
		else: 
