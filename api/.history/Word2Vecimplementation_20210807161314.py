...
class Word2VecModel:
    def __init__(self, tweets_data):
        ...
        print (self.model.wv.key_to_index.keys())
    ...
    def create_model(self, corpus):
        ...
        #t = time()
        w2v_model = w2v_model.build_vocab(corpus_iterable = corpus, progress_per=1000)
        #print('Time to build vocab: {} mins'.format(round((time() - t) / 60, 2)))
        #t = time()
        #w2v_model = w2v_model.train(corpus_iterable = corpus, total_examples=w2v_model.corpus_count, epochs=30, report_delay=1)
