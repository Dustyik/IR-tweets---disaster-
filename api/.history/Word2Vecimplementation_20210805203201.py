...
class Word2VecModel:
    def __init__(self, tweets_data):
        ...
        self.modelVocab = Word2Vec.build_vocab(self.corpus)
    ...
    def create_model(self, corpus):
        ...
        t = time()
        w2v_model.build_sentences(sentences = corpus, progress_per=1000)
        print('Time to build vocab: {} mins'.format(round((time() - t) / 60, 2)))
        t = time()
        w2v_model.train(sentences = corpuse, total_examples=w2v_model.corpus_count, epochs=30, report_delay=1)
