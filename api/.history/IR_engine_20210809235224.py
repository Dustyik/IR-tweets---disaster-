from QueryLikelihoodModelImplementation import QueryLikelihoodModel
...
class DataProcessor:
	...
	def returnTweetsBasedOnSearchModel(self, articleId, articleTitle, searchModel):
		...
		if searchModel == SEARCH_MODELS["ULM"]:
			rankedDocs = self.queryLikelihoodModel(articleId, articleTitle)
...
dataProcessor = DataProcessor()
return_BERT_query(dataProcessor.tweets_data, test_title_1)
