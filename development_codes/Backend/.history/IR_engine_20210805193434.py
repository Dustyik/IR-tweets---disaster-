...
class DataProcessor:
	...
	def Word2Vecquery(self, articleId, articleTitle):	
		self.word2VecModel.return_most_significant_tweets(articleTitle)
		return 
	...
	def BM25query(self, articleId, articleTitle):
		...
		for col in return_dataFrame.columns:
			print (col)
...
dataProcessor = DataProcessor()
returnTweetsBasedOnSearchModel(dataProcessor, "testId", test_title_1, )
dataProcessor.