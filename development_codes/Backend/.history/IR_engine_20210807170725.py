...
def returnTweetsBasedOnSearchModel(dataProcessor, articleId, articleTitle, searchModel):
	...
	if searchModel == SEARCH_MODELS["W2Vcs"]:
		return dataProcessor.Word2Vecquery(articleId, articleTitle, SEARCH_MODELS["W2Vcs"])
...
class DataProcessor:
	...
	def Word2Vecquery(self, articleId, articleTitle, type = SEARCH_MODELS["W2Vcs"]):	
		rankedDocs = self.word2VecModel.return_most_significant_tweets(articleTitle, type = SEARCH_MODELS["W2Vcs"])[:RETURN_SIZE]
		return rankedDocs
