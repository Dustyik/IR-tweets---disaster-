...
class CosineSimilarity:
    def __init__(self, tweets, type='tfidf'):
    ...
    def get_result(self):
        ...
        top_ind = np.flip(np.argsort(cos_sim[0]))
        ...
        for i in top_id:
            ...
            for ind, r in filt.iterrows():
                ...
                self.result.append({'tweet_id':id, 'tweet': text, 'article_id':related, "relevance_score": rel, "clean_text": clean_text})
...
class EuclideanDistance:
    def __init__(self, tweets, type='tfidf', return_size = 30):
        self.tweets = tweets #contains tweets data
        self.vectorizer = self.change_matrix_type(type)
