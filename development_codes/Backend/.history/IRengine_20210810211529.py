...
class DataProcessor:
	...
	def average_model_performance(self, frac = 0.02):
		...
		#pandas_df = self.returnTweetsBasedOnSearchModel(articleId = articleId, articleTitle = articleTitle, searchModel = searchModel)
...
dataProcessor = DataProcessor()
dataProcessor.average_model_performance()
