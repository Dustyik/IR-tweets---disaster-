...
import numpy as np
import pandas as pd
import BM25implementation import *
...
class Word2VecModel:
    ...
    def document_embedding_w2v(self, pandasRow):
        embeddings = []
        if len(doc_tokens) < 1:
    ...
    def return_most_significant_tweets(self, query, n):
        ...
        self.tweets_data["vector"] = self.tweets_data.apply(lambda x:get_friends_followers_ratio(x), axis=1)
