...
export const GlobalProvider = ({ children }) => {
    ...
    function addSearchModels(model){
        dispatch({
    ...
    function removeSearchModels(model){
        dispatch({
            type: "REMOVE_SEARCH_MODEL",
            payload:model
        })
    }
    ...
    <GlobalContext.Provider 
        value={{ tweets: state.tweets, setTitle, getTweet, title:state.title, addSearchModels, searchModels:state.searchModels}}>
        {children}
    </GlobalContext.Provider>)
}
