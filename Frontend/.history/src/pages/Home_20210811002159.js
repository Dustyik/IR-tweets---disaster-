...
export const Home = () => {
    ...
    const randomButtonClick = () => {
        if (titlesState.length == 0){
            return alert("Thee are no test article titles in the front end yet! \
            You must first retrieves test article titles from the back end! the back end is likely still starting up or has yet to be connectd")
        }
